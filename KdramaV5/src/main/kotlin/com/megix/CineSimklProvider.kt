...
class CineSimklProvider: MainAPI() {
    ...
    override val mainPage = mainPageOf(
        "/tv/genres/drama/all-types/kr/all-networks/all-years/popular-today?limit=$mediaLimit" to "Korean Drama - Popular",
        "/tv/genres/drama/all-types/cn/all-networks/all-years/popular-today?limit=$mediaLimit" to "Chinese Drama - Popular",
        "/tv/genres/all/all-types/kr/all-networks/all-years/popular-today?limit=$mediaLimit" to "Korean Shows - Trending",
        "/tv/genres/all/all-types/cn/all-networks/all-years/popular-today?limit=$mediaLimit" to "Chinese Shows - Trending",
        "/tv/genres/all/all-types/kr/all-networks/all-years/rank?limit=$mediaLimit" to "Korean Shows - Top Rated",
        "/tv/genres/all/all-types/cn/all-networks/all-years/rank?limit=$mediaLimit" to "Chinese Shows - Top Rated",
